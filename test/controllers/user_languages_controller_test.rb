...
class UserLanguagesControllerTest < ActionController::TestCase
  ...
  test "should create user_language" do
    assert_difference('UserLanguage.count') do
      post :create, user_language: { language_id: @user_language.language_id, proficiency: @user_language.proficiency, user_id: @user_language.user_id }
    end
  ...
  test "should update user_language" do
    patch :update, id: @user_language, user_language: { language_id: @user_language.language_id, proficiency: @user_language.proficiency, user_id: @user_language.user_id }
    assert_redirected_to user_language_path(assigns(:user_language))
  end
