...
class ReleasesControllerTest < ActionController::TestCase
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post :create, release: { deliver_date: @release.deliver_date, project_id: @release.project_id, version: @release.version }
    end
  ...
  test "should update release" do
    patch :update, id: @release, release: { deliver_date: @release.deliver_date, project_id: @release.project_id, version: @release.version }
    assert_redirected_to release_path(assigns(:release))
  end
