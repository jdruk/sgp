...
class ThemesControllerTest < ActionController::TestCase
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post :create, theme: { description: @theme.description, name: @theme.name, project_id: @theme.project_id }
    end
  ...
  test "should update theme" do
    patch :update, id: @theme, theme: { description: @theme.description, name: @theme.name, project_id: @theme.project_id }
    assert_redirected_to theme_path(assigns(:theme))
  end
