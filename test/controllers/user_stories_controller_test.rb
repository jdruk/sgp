...
class UserStoriesControllerTest < ActionController::TestCase
  ...
  test "should create user_story" do
    assert_difference('UserStory.count') do
      post :create, user_story: { business_value: @user_story.business_value, description: @user_story.description, sprint_id: @user_story.sprint_id, status: @user_story.status, story_points: @user_story.story_points, theme_id: @user_story.theme_id }
    end
  ...
  test "should update user_story" do
    patch :update, id: @user_story, user_story: { business_value: @user_story.business_value, description: @user_story.description, sprint_id: @user_story.sprint_id, status: @user_story.status, story_points: @user_story.story_points, theme_id: @user_story.theme_id }
    assert_redirected_to user_story_path(assigns(:user_story))
  end
